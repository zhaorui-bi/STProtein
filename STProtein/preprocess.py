...
def construct_neighbor_graph_one(adata_omics1, datatype='SPOTS', n_neighbors=3): 
    """
    Construct neighbor graphs, including feature graph and spatial graph. 
    Feature graph is based expression data while spatial graph is based on cell/spot spatial coordinates.
    ...
    ################# feature graph #################
    feature_graph_omics1 = construct_graph_by_feature_one(adata_omics1)
    adata_omics1.obsm['adj_feature'] = feature_graph_omics1
    
    data = {'adata_omics1': adata_omics1}
...
def construct_graph_by_feature_one(adata_omics1, k=20, mode= "connectivity", metric="correlation", include_self=False):
...
def adjacent_matrix_preprocessing_one(adata_omics1):
    """Converting dense adjacent matrix to sparse adjacent matrix"""
